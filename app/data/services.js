export const services = [
  ...
  },
  {
    ...
    longTextRte: `<p>LBE conducts comprehensive biological and plant surveys to assess the health, diversity, and ecological value of aquatic habitats. Our team of experienced biologists and botanists utilizes scientifically rigorous methods to gather accurate and reliable data on the flora and fauna present in your waterbody.</p>
  ...
  },
  {
    ...
    description:
      "We utilize state-of-the-art technologies and methodologies to gather high-resolution data on aquatic plant communities, shoreline characteristics, and (non navigation related) underwater topography.",
    longTextRte: `<p>Little Bear offers a suite of advanced survey techniques to provide detailed and accurate assessments of your aquatic environments. Our team of experienced professionals utilizes state-of-the-art technologies and methodologies to gather high-resolution data on aquatic plant communities, shoreline characteristics, and underwater topography (not for navigation).</p>
